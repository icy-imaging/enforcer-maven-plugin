...
This is the repository for the Maven configuration of *Enforcer*, a Maven plugin for [bioimage analysis software Icy](https://icy.bioimageanalysis.org/) and its plugins,
...
The [source code of Icy](https://gitlab.pasteur.fr/bia/icy/icy) is also licensed under the LGPLv3 license.

## Description

Manage the build and the deployment of Icy extensions.
